...
describe('#Reducer: Workshop', () => {
  ...
  it(`When Action ${RECEIVE_WORKSHOP} return state`,() => {
    expect(workshop("", { type: RECEIVE_WORKSHOP, workshop: "React Fundamentals" })).toEqual("React Fundamentals")
    expect(workshop("", { type: RECEIVE_WORKSHOP, workshop: "React Fundamentals" })).toMatchSnapshot()
  })
})